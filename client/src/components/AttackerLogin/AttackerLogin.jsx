...
import AttackerSvg from "../../Images/Hacker.svg";
    ...
    <React.Fragment>
      ...
      >
        <div className="d-flex align-items-center justify-content-center login-flex ">
          <div className="col-md-6 d-flex align-items-center justify-content-center attacker-login-side">
            <div className="img-container">
              <img src={AttackerSvg} className="img-fluid" alt="login-banner" />
            </div>
          </div>
          <div className="col-md-6 d-flex align-items-center justify-content-center flex-column login-flex-col attacker-login-change">
            <form className="sign-in-form" onSubmit={submitSignin}>
              <h2 className="title">Attacker Login</h2>
